...
<div class="container-wrapper">
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}//product/addProduct" method="post"
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="dresses" />Dresses</label>
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="toys" />Toys</label>
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="stroller" />Stroller's</label>
        </div>
